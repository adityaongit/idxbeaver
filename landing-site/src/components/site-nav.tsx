        ...
        <div className="mx-auto flex h-[56px] max-w-[1360px] items-center justify-between px-5 sm:px-6">
          ...
          <div className="hidden items-center gap-1 lg:flex">
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-[8px] text-[var(--color-ink-dim)] transition-colors hover:bg-white/[.04] hover:text-[var(--color-ink)]"
            >
            ...
            <a
              ...
              className="flex h-9 items-center gap-2 rounded-[8px] px-2.5 text-[13.5px] font-medium text-[var(--color-ink)] transition-colors hover:bg-white/[.05]"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
