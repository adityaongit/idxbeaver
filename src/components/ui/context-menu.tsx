...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/15 data-[variant=destructive]:focus:text-destructive relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
        className
      )}
      {...props}
    />
...
function ContextMenuLabel({
  ...
  return (
    <ContextMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn("text-foreground px-2 py-1.5 text-xs font-black uppercase tracking-wide data-[inset]:pl-8", className)}
      {...props}
    />
  )
}
